...
import ServiceSupports from "../src/pages/Service/ServiceSupports"
import CheckoutFlow from '../src/pages/CheckoutPage/CheckoutFlow'
function App() {
  return (
    <div className="App">
      <CartProvider>
      ...
      <Router>
        <Routes>
          ...
          <Route path="/Service" element={<ServiceSupports />} />
          <Route path="/check" element={<CheckoutFlow />} />
