...
const MacbookSupport = () => {
  ...
  return (
    <div className="font-sans">
      ...
      <h1 className="text-3xl text-cyan-700 font-sora font-bold py-4">Macbook Support</h1>
      {/* Buttons Section */}
      ...
      <div className="px-2">
        {services.map((service, index) => (
          ...
          <div className="relative flex items-center justify-center w-1/4 mr-2 font-sora">
            <img
              src={service.image}
              alt=""
            ...
            />
            <button
              className={`absolute -bottom-3 px-2 pt-1 pb-[1px] rounded-md border-2 text-sm border-cyan-700 ${
