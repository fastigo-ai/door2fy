...
const CodingSupport = () => {
  ...
  const services =
    activeServiceType === "BookingSupport"
      ? [
        {
            name: "React Native code issue",
            description: "Recognizing React Native’s Framework ",
            price: 299,
            image: "/assets/images/Login.webp"
          },
          {
            name: "JAVA related issue",
            description:
          ...
          {
            name: "Docker related issue",
            description: "Container related issue ",
            price: 299,
            image: "/assets/images/Login.webp"
          },
      ...
      : [
        {
          ...
          },
          {
            ...
            description:
              "we provide licence for your window PC or Laptop licence validate for 1 year ",
            price: 99,
            image: "/assets/images/Login.webp"
          },
          {
            name: "Windows Driver Related issue",
            description: "we fix all driver related issue in just few minutes",
            price: 99,
            image: "/assets/images/Login.webp"
          },
          {
            name: "MS Office related issue",
            description:
              "We handle everything! Select this if you are not sure of the issue",
            price: 99,
            image: "/assets/images/Login.webp"
  ...
  return (
    <div className="font-sans">
      ...
      <h1 className="text-3xl text-cyan-700 font-sora font-bold py-4">Coding Support</h1>
      {/* Buttons Section */}
